...
namespace Qa.UseExistDbContext.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update UseExistDbContextDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update UseExistDbContextEfCoreEntityExtensionMappings to extend the IdentityUser entity
