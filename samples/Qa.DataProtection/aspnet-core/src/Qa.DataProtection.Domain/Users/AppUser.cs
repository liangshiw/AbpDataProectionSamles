...
namespace Qa.DataProtection.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DataProtectionDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DataProtectionEfCoreEntityExtensionMappings to extend the IdentityUser entity
